...
public final class TestSchema {
    ...
    public static final Field<String> RESOURCES_OWNER =
            DSL.field(DSL.name("resources", "owner_id"), SQLDataType.VARCHAR);
    public static final Field<String> RESOURCES_STATUS =
            DSL.field(DSL.name("resources", "status"), SQLDataType.VARCHAR);
    public static final Field<Boolean> RESOURCES_ABOOL =
            DSL.field(DSL.name("resources", "a_bool"), SQLDataType.BOOLEAN);
    public static final Field<Integer> RESOURCES_PRIO =
            DSL.field(DSL.name("resources", "priority"), SQLDataType.INTEGER);
    public static final Field<String> RESOURCES_DEPT =
            DSL.field(DSL.name("resources", "department"), SQLDataType.VARCHAR);
    public static final Field<String> RESOURCES_OPT =
            DSL.field(DSL.name("resources", "optional_str"), SQLDataType.VARCHAR);

    public static final Table<Record> RESOURCE_TAGS = DSL.table(DSL.name("resource_tags"));
    public static final Field<String> RT_RESOURCE_ID =
            DSL.field(DSL.name("resource_tags", "resource_id"), SQLDataType.VARCHAR);
    ...
    public static final Field<String> CAT_RESOURCE_ID =
            DSL.field(DSL.name("categories", "resource_id"), SQLDataType.VARCHAR);
    ...
    public static final Field<String> SUB_CAT_ID =
            DSL.field(DSL.name("subcategories", "category_id"), SQLDataType.VARCHAR);
