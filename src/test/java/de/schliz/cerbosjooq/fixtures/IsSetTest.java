...
class IsSetTest {
    ...
    void isSet_true_rendersIsNotNull() {
        var plan = conditional(expr("isSet",
                variable("request.resource.attr.optional"),
                value(true)));
    ...
    @Test
    void ltNull_throws() {
        var plan = conditional(expr("lt",
                variable("request.resource.attr.priority"),
                value(null)));
